...
namespace Lofmp\ProductListGraphQl\Model\Resolver\Products\Query;
...
use Lofmp\ProductListGraphQl\Model\Resolver\Products\DataProvider\Product as ProductProvider;
...
class Filter implements ProductQueryInterface
{
    ...
    public function getResult(
        ...
        try {
            ...
            $searchResults = $this->productDataProvider->getList(
                $searchCriteria,
                $fields,
                false,
                false,
